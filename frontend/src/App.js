...
function App() {
  ...
  return (
    <div className="mx-20 my-2 flex flex-col min-h-[24rem]">
      <Navbar loggedIn={loggedIn} userData={userData} setMenu={setMenu} menu={menu} />
      <Routes>
        <Route
          path="/"
          element={<Home handleLogOut={handleLogOut} loggedIn={loggedIn} setMenu={setMenu}/>}
        ></Route>
        <Route
          path="/profile"
        ...
        <Route
          path="/signup"
          element={<SignUp matchPass={matchPass} registerUser={registerUser} />}
        ></Route>
        <Route
          path="/login"
